...
const SUITES = [
  ...
  ['tspot',     '区画の同時編集'],
  ['tgap',      '区画を足すとき、欠番を埋める'],
  ['tvpair',    '縦列ペア連動（棟ちがいに写らない）'],
  ['tghost',    '幻の予約さがし（写り込みを見つける）'],
  ...
  ['theal',     '中身が空になった手元のデータが、クラウドから戻る'],
  ['tnewver',   '新しい版が出たら、画面が自分で気づく'],
  ['twari',     '30％保証の日割り（画面と LINE で金額が合う）'],
  ['timg',      '画像を、あきらめずに取りにいく'],
  ['tlogo',     '画面まわり'],
  ['tinv',      'マイページへ送る（招待済みの表示／1名だけ送る）'],
  ['tarea',     'PIVOT2 と PIVOT3 のエリア判定が、2つのファイルで食いちがわない'],
];
