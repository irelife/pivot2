/* =====================================================================
   ...
   （例：総社市は PIVOT2（広島）の担当です。①に当てはまらないので、
     エスプレイスビルドのような総社市の物件は、はじめから対象外です）
...
(function(){
  ...
  /* 倉敷市老松町・総社市 は、住所は岡山県ですが PIVOT2（広島）の担当です。
     倉敷市老松町 … ベラカーサ3棟・アンティカベラカーサ
     総社市       … エスプレイスビルド ほか
     まちがって消さないよう、こちら側として数えます。

     ★ 2026-09-23 の直し
       ここに「総社市」が無く、ownerimport.js は
       「広島エリア … 広島県 ＋ 倉敷市老松町 ＋ 総社市」としていました。
       つまり ownerimport.js が PIVOT2 に入れた総社市の物件を、
       この道具が「よそのエリア」として消す候補に挙げていました。
       （区画0・契約なし・画像なし の1件だけが対象で、
         中身のあるものは守られます。消す前に一覧と確認も出ます）
       ownerimport.js の OI_AREA_HIROSHIMA と同じ並びにそろえました。
       ★ この2つがまた食いちがわないよう、tests/tarea.cjs が見張ります。 */
  var HIROSHIMA = ['広島県', '倉敷市老松町', '総社市'];
  var OKAYAMA   = ['岡山県'];
